...
\hrule
\vspace{3pt}
\footnotesize Refused \emph{by name} rather than silently approximated: a
\emph{metal}'s ultrasoft dynamical matrix, $\chi^{(2)}$, phonons at $q\neq0$, EXX.
\end{frame}
...
\includegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{figs/02_silicon_scf_and_bands.png}
\\[2pt]
...
\begin{columns}[c]
\column{0.5\textwidth}
\includegraphics[width=\textwidth,height=0.56\textheight,keepaspectratio]{figs/06_density_of_states.png}
\column{0.5\textwidth}
\includegraphics[width=\textwidth,height=0.56\textheight,keepaspectratio]{figs/16_projected_density_of_states.png}
\end{columns}
\vspace{2pt}
...
\begin{columns}[c]
\column{0.5\textwidth}
\includegraphics[width=\textwidth,height=0.56\textheight,keepaspectratio]{figs/07_spin_polarization.png}
\column{0.5\textwidth}
\includegraphics[width=\textwidth,height=0.56\textheight,keepaspectratio]{figs/08_spin_orbit_coupling.png}
\end{columns}
\vspace{2pt}
\footnotesize
...
\begin{columns}[c]
\column{0.5\textwidth}
\includegraphics[width=\textwidth,height=0.50\textheight,keepaspectratio]{figs/09_forces_and_relaxation.png}
\column{0.5\textwidth}
\includegraphics[width=\textwidth,height=0.50\textheight,keepaspectratio]{figs/15_stress.png}
\end{columns}
\vspace{2pt}
\footnotesize
...
fall out of one gradient. QE's six terms are implemented beside it \textbf{as a
cross-check} --- which found the augmentation force's sign. Relaxed geometries
reproduce \qe\ to 1e-6 bohr.
\end{frame}
...
\includegraphics[width=\textwidth,height=0.50\textheight,keepaspectratio]{figs/19_linear_response.png}
\column{0.33\textwidth}
\includegraphics[width=\textwidth,height=0.50\textheight,keepaspectratio]{figs/20_phonons.png}
\column{0.33\textwidth}
\includegraphics[width=\textwidth,height=0.50\textheight,keepaspectratio]{figs/26_raman_and_infrared_spectra.png}
\end{columns}
\vspace{3pt}
\footnotesize
...
\footnotesize \textbf{PAW is what makes it work}: its one-centre $\tau$ recovers
$c=1.107$ against an all-electron 1.12, where norm-conserving silicon measures
1.000.
\column{0.43\textwidth}
\includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{figs/24_tran_blaha_band_gaps.png}
\\[3pt]
\footnotesize
...
\begin{center}
\includegraphics[width=0.80\textwidth,height=0.70\textheight,keepaspectratio]{figs/gpu-vs-cpu-fig.png}
\end{center}
\vspace{-4pt}
\footnotesize
JAX already emitted GPU code from this source. \textbf{The finding is that the two
batching dials invert}: tuned for a CPU cache they cost \textbf{4.5x} on a GPU,
and the plausible half-measure (\texttt{k=all, b=1}) is the \emph{worst} setting.
\end{frame}

% ---------------------------------------------------------------- 11
\begin{frame}{GPU across the physics --- 12 cases, 10--40 atoms}
\begin{center}
\includegraphics[width=0.95\textwidth,height=0.66\textheight,keepaspectratio]{figs/gpu-sweep-fig.png}
\end{center}
\vspace{-4pt}
\footnotesize
...
\begin{itemize}\itemsep2pt
  ...
  \item the ultrasoft dynamical matrix of a \emph{metal}

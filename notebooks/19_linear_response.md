...
A heavy element is almost always described with an ultrasoft or PAW dataset, and
that combination runs too. On AlAs with both species relativistic, the dielectric
constant is 9.528811 against Quantum ESPRESSO's 9.528846, and spin-orbit coupling
is worth 0.0086 of it, so the agreement is far finer than the effect being added.
The Born charges of the same run are 2.101143 on aluminium and -2.165831 on
arsenic, against 2.10114 and -2.16587.

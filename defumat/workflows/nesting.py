...
:mod:`defumat.response.nesting`. The physics is in that module; what is here
...
all of them. :func:`~defumat.system.kpoints.grid_equivalence` is the map --
...
:func:`~defumat.workflows.nscf.grid_symmetry` for that reason, and the check
    ...
    *,
    ...
    Args:
        ...
        smearing: the delta's shape, a name from
            :data:`~defumat.scf.occupations.SMEARING_ORDER`. Defaults to
    ...
    Returns:
        :class:`~defumat.response.nesting.NestingFunction`.
    """

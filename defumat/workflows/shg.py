...
:mod:`defumat.response.shg`. The same shape as
:func:`~defumat.workflows.photocurrent.run_shift_current`, and the same two
...
only over a complete basis. :attr:`~defumat.response.shg.SecondHarmonic.
...
def run_shg(
    ...
    *,
    ...
    :func:`~defumat.response.shg.second_harmonic`'s.
    """

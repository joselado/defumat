...
:func:`~defumat.workflows.sfac.run_structure_factors`.
...
def h_vectors(cell, hmax: float, symmetries=None, reduce: bool = True,
    ...
    Args:
        cell: the crystal's :class:`~defumat.system.cell.Cell`.
...
def _collapse_stars(miller, length, rotations):
    ...
    (:class:`~defumat.system.symmetry.Symmetries`), so the image is a matrix

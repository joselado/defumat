...
many k-points are in flight is :mod:`defumat.batching`'s dial here, but a
...
from defumat.solvers.davidson import davidson_eigensolver, davidson_eigensolver_all

...
from defumat.units import ANGSTROM_TO_BOHR
...
class Species(eqx.Module):
    ...
    the phonons (:mod:`defumat.response.phonon`), which divide the force
...
class Structure(eqx.Module):
    ...
    def masses(self) -> np.ndarray:
        ...
        :data:`~defumat.units.AMU_TO_RY` and belongs where the mass meets an

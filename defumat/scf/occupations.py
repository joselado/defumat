...
def tetrahedra_for(occupations: str, kpoints, symmetries, cell):
    ...
    place; the implementation is :mod:`defumat.scf.tetrahedra`, which is
...
def tetrahedron_occupations(tetrahedra, eigenvalues, weights, nelec):
    ...
    """
    from defumat.scf.tetrahedra import tetrahedron_occupations as _occupations
...
def tetrahedron_occupations_spin(tetrahedra, eigenvalues, weights, nelec, counts=None):
    ...
    """
    from defumat.scf.tetrahedra import tetrahedron_occupations_spin as _occupations

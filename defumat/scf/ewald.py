...
from defumat.system.cell import Cell, lattice_translations, pair_separation_bound
from defumat.system.structure import Structure
from defumat.units import E2, TPI
...
#: them (:mod:`defumat.vdw.grimme`), so they live in :mod:`defumat.system.cell`
...
def _reciprocal_kernel(g, tau, charges, alpha, volume, factor):
    ...
    #
    # This is :func:`defumat.scf.density.band_density`'s trap, and
    # :func:`defumat.basis.gvectors.modulus`'s, and
    # :mod:`defumat.forces.energy`'s, in a **fourth** place. What is new here is

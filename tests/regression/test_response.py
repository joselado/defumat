...
def _drop_compiled_code():
    ...
    Forty-seven of this file's failures on a cluster node were
    ``INTERNAL: Failed to materialize symbols``, which is what a file that runs
    the whole linear-response stack over several cells accumulates.

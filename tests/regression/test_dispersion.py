...
def _drop_compiled_code():
    ...
    Sixty of this file's failures on a cluster node were
    ``INTERNAL: Failed to materialize symbols``: a dispersion walks several
    wavevectors and each one is its own set of shapes.

...
from pypresso.tddft.kernels import get_kernel
...
def solve_dyson(
    ...
    *,
    ...
    Args:
        chi: the :class:`~pypresso.tddft.chi0.ChiZero` to screen.
        kernel: a name from :func:`~pypresso.tddft.kernels.kernel_names`.

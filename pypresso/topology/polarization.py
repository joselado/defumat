...
Structurally this is the same object :mod:`pypresso.topology.wilson` already
...
``degspin`` trap :mod:`pypresso.response.conductivity` records: the strings hold
...
from pypresso.topology.links import link_phase

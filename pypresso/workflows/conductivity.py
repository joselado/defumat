...
Kubo-Greenwood sum of :mod:`pypresso.response.conductivity`. It is the same
shape as :func:`~pypresso.workflows.tddft.run_absorption` and for the same
    ...
    *,
    ...
    Args:
        ...
        kpoints: the k-set the conductivity is evaluated on, if it is not the
            ...
            :func:`~pypresso.response.conductivity.require_a_conductivity_regime`.
    ...
    :func:`~pypresso.response.conductivity.optical_conductivity`'s.
    """

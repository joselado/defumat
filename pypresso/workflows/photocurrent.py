...
:mod:`pypresso.response.photocurrent`. The same shape as
:func:`~pypresso.workflows.conductivity.run_conductivity`, and the same two
...
they span the space. :attr:`~pypresso.response.photocurrent.ShiftCurrent.
...
def run_shift_current(
    ...
    *,
    ...
    :func:`~pypresso.response.photocurrent.shift_current`'s.
    """

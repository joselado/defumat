...
introduces it. What that costs is set out in :mod:`pypresso.xc.functional` and
...
libxc's convention both. :func:`pypresso.scf.density.kinetic_energy_density`
...
#: than evaluated. It is the GGA gate of :mod:`pypresso.xc.functional`
...
def tb09_potential(rho, sigma, laplacian, tau, c, gamma=BR89_GAMMA):
    ...
    **Zero below the density threshold**, and the points below it are evaluated
    ...
    (:func:`pypresso.xc.functional._sanitise`) and it matters more here: the

...
class Projector:
    ...
    #: coupling is built from -- see :mod:`pypresso.pseudo.spinorbit`.
    j: float | None = None
...
class PawData:
    ...
    #: :mod:`pypresso.scf.potential` refuses that combination anyway.
...
def _read_spin_orbit(root, path: Path, header: dict, projectors, orbitals):
    ...
    (:mod:`pypresso.pseudo.spinorbit`): without it the two projectors of a pair

...
\begin{tabular}{@{}lrrrr@{}}
\toprule
$e_{14}$, C/m$^2$ & \code{4 4 4} & \code{6 6 6} & \code{8 8 8} & \code{10^3} \\
\midrule
...
successive differences shrink by about a factor of five a rung, so roughly
$0.0008$ is left after \code{10^3} and the two routes end up about one per
cent apart, which is comparable with what the reference itself is known to. The reason

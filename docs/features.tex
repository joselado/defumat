...
invariant vector, which is what is checked. Beyond that: insulators, and
everything the Sternheimer regime and the differentiable cell refuse (a spin
spiral, a magnetic field, a shifted grid run with \code{nosym}).
\end{refuses}

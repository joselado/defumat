...
Meta-GGA. Spin polarization of any kind, collinear or noncollinear --- which is
where a spin density wave lives, and is the next stage rather than a permanent
refusal. DFT+U, the occupation matrix being per atom where an ultracell has $N$
copies of each. Spin spirals, as a second modulation of the same states.

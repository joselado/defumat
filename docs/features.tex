...
a noncollinear run, $\langle L\rangle$ and $\langle S\rangle$ are averaged over
the group as \textbf{axial} vectors --- each operation carrying $\det(R)$ and the

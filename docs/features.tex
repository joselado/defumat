...
two routes read $1.473304405$ and $1.473304408$ on ultrasoft AlAs where they
had been 1.6 per cent apart. \textbf{PAW is still refused by name}, because its
one-centre energy is a function of \code{becsum} directly and the cross term
that reaches is on no grid.
...
comparison against something outside this code and not a missing term. Beyond that: insulators, \code{nspin = 1}, and

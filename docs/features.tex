...
easy axis along $z$. What this is for is relaxing the orientation of a texture,
the easy axis of a magnet or the plane of a spiral, which is planned in
\code{ORIENTATION-NEXT.md}; a four-component source whose moments are not
collinear is refused for now, by name.

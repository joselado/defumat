...
the matrix. With spin-orbit coupling the partners still remove the preference
between $+\hat{\mathbf e}_0$ and $-\hat{\mathbf e}_0$, which is what the NiBr2
remnant above is; whether that is enough there is not yet measured.

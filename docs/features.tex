...
\emph{strain} coordinate is what stays norm-conserving: it shares
\code{\_position\_response} with the Raman tensor and would inherit the tail
that closed it, but the occupied block's analogue under a strain has not been
measured, and that phase's lesson is that one of the pair alone is worse than
neither.

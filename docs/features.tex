...
\begin{tabular}{@{}lrrr@{}}
\toprule
$e_{14}$, C/m$^2$ & \code{4 4 4} & \code{6 6 6} & \code{8 8 8} \\
\midrule
this code, a \code{jvp} of the stress & $-0.763786$ & $-0.687475$ & $-0.672897$ \\
...
is the response route that is unconverged rather than the reference. The reason

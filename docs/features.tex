...
invariant under flipping every spin together with the sign of $B$, so a spin
density wave driven by \code{magnetic\_field} is almost invisible in the charge
and lives entirely in the magnetization; \code{spin} and \code{polarization}
project it, exactly as they do for a unit-cell image.

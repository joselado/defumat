...
Validated on a fully-relativistic \textbf{ultrasoft} dataset too, on the same
cell and to the same numbers. Norm-conserving is untested rather than refused
--- no reference case is committed for it.

...
$+8.14\times10^{-5}$, $+3.56\times10^{-6}$, $+4.06\times10^{-7}$ and
$+1.85\times10^{-7}$~Ry at \code{nbnd = 12, 24, 48, 64} on that same silicon
...
$+8.14\times10^{-5}$, $+3.56\times10^{-6}$, $+4.06\times10^{-7}$ and
$+1.85\times10^{-7}$~Ry at \code{nbnd = 12, 24, 48, 64}.
...
then comes out $1.06\times10^{-7}$~Ry \emph{below} the supercell. Choose a
